...
- (void)show
{
    ...
    if (self.messageString) {
        ...
        messageLabel.textColor = WDMessageTextColor;
        messageLabel.font = [UIFont fontWithName:WDMessageFont size:14.];
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        [self performSelector:@selector(hide) withObject:nil afterDelay:WDMessageDisplayDuration ];
    }];
}
...
+ (void)showMessage:(NSString*)message withCustomView:(UIView*)customView inView:(UIView*)container withTopMargin:(BOOL)withTopMargin withBackgroundColor:(UIColor*)backgroundColor callback:(void (^)())callback
{
    ...
    messageView.backgroundColor =(backgroundColor == nil)?WDMessageBackgroundColor:backgroundColor ;
...
+ (void)showMessage:(NSString*)message inView:(UIView*)container withTopMargin:(BOOL)withTopMargin
{
    ...
    [WDMessage showMessage:message inView:container withTopMargin:withTopMargin withBackgroundColor:WDMessageBackgroundColor];
